...
class PLAYGROUND_MANGMENT_BOOKING:
    ...
    def __init__(self):
        ...
        def tor(self):
            ...
            if self.ch == 1:
                ...
                self.price = self.price + (30000 * self.no_of_days)
                m[0] = 3
            elif self.ch == 4:
        ...
        root.title("PLAYGROUND MANGMENT")
        ...
        self.Message3.configure(text='''Book a playground''')
        ...
        self.Label6.configure(text='''CHOOSE YOUR STADIUM''')
        ...
        self.Checkbutton1.configure(text='''MAHATMA STADIUM''')
        ...
        self.Checkbutton2.configure(text='''NEHRU STADIUM''')
        ...
        self.Checkbutton3.configure(text='''AP STADIUM''')
        ...
        self.Checkbutton4.configure(text='''PB STADIUM''')
...
if __name__ == '__main__':
    hotel=PLAYGROUND_MANGMENT_BOOKING()
