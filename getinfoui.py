    ...
    def __init__(self):
        def gotinfo():
            ...
            if self.gettininfo.isdigit() == True and len(self.gettininfo) != 0:
                self.Text1.insert(INSERT, " booking info is ""\n")
            else :
                self.Text1.insert(INSERT,"not available""\n")
            ...
            try:
                ...
                while True:
                    ...
                    if self.gettininfo == a:
                        ...
                        if n == 0:
                            print("NO booking in that date", self.gettininfo)
                        else:
                            n = 0
                            continue
            except EOFError:
