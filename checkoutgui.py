    ...
    def __init__(self):
        def check_room():
            ...
            if self.rom.isdigit() == True and len(self.rom) != 0:
                self.Text1.insert(INSERT, "BOOKING HAS BEEN CANCELLED MONEY WILL BE REFUNDED ""\n")
                v = int(self.rom)
                f = open("hotel.dat", "rb")
                f1 = open("hote.dat", "ab")
                n = 0
                try:
                    ...
                    if n == 0:
                        self.Text1.insert(INSERT, "NO BOOKING FOUND""\n")
                ...
                self.Text1.insert(INSERT, "invalid input please input a valid DATE.""\n")
        ...
        root.title("PLAYGROUND MANAGEMENT SYSTEM")
        ...
        self.Label1.configure(text='''ENTER THE DATE   :''')
